...
namespace project2.Migrations
{
    ...
    [Migration("20251117070236_DocumentUpdateAndAddedReviewEntity")]
    partial class DocumentUpdateAndAddedReviewEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("project2.Models.Coupon", b =>
                {
            ...
            modelBuilder.Entity("project2.Models.UserPurchase", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("project2.Models.Document", b =>
                {
                    b.HasOne("project2.Models.AppUser", "Author")
            ...
            modelBuilder.Entity("project2.Models.Review", b =>
                {
                    ...
                    b.HasOne("project2.Models.AppUser", "User")
                        .WithMany("Reviews")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
