...
import { Container, Title, Text, Loader, SimpleGrid, Paper, Group, Badge, Pagination, Button, Select } from '@mantine/core';
                ...
                <>
                    ...
                    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                        <div className="flex flex-wrap items-center gap-3">
                            ...
                            <Group gap="xs">
                                <Button
                                    variant={sortBy === 'relevant' ? 'filled' : 'light'}
                                    size="sm"
                                ...
                                <Button
                                    variant={sortBy === 'bestSelling' ? 'filled' : 'light'}
                                    size="sm"
                            ...
                            <Select
                                ...
                                styles={{
                                    input: {
                                        backgroundColor: sortBy.includes('price') ? '#228be6' : 'white',
                                        color: sortBy.includes('price') ? 'white' : 'black',
                                        fontWeight: sortBy.includes('price') ? 500 : 400,
                                    }
                                }}
                            />
                        </div>
