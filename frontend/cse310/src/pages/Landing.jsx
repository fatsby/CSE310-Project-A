...
// Assets
// ===========================
import GreenBgIMG from "../assets/Landing/green-bg.png";
      ...
      <div className="container mx-auto w-fit">
        ...
        <section ref={premiumRef} className="w-full px-18 flex flex-col">
          ...
          <div className="flex justify-center my-14">
            <button className="px-8 py-3 bg-[#4192fd] text-[#F1F3FB] rounded-full hover:bg-blue-600 transition font-medium text-[16px] cursor-pointer">
              Go Premium
            </button>
          </div>
        </section>
