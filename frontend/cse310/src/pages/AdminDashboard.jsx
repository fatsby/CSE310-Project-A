    ...
    const fetchAnalytics = async () => {
        ...
        try {
            const [
                ...
                fetch(`${API_URL}/api/purchases/totalSales`, {
                    method: 'GET',
                    headers,
                }),
                fetch(`${API_URL}/api/reviews/averageRating`, {
                    method: 'GET',
                    headers,
                }),
                ...
                fetch(`${API_URL}/api/documents/count`, {
                    method: 'GET',
                    headers,
                }),
                fetch(`${API_URL}/api/reviews`, { method: 'GET', headers }),
                fetch(`${API_URL}/api/purchases/all`, {
                    method: 'GET',
                    headers,
                }),
            ])
            ...
            if (ratingRes.ok)
                setAvgPlatformRating(Number(await ratingRes.json()).toFixed(2))
    ...
    const deleteUser = async (email) => {
        try {
            const banRes = await fetch(
                `${API_URL}/api/users/admin/ban-switch/${email}`,
                {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
            ...
            setError(`Error banning/unbannign user: ${err.message}`)
        }
    }
        ...
        <div className="container mx-auto px-4 pb-6 pt-[110px]">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 mb-4">
                <div>
                    ...
                    <Text c="dimmed">
                        Manage users, items, reviews, transactions & platform
                        analytics
                    </Text>
                </div>
                <Group gap="xs">
