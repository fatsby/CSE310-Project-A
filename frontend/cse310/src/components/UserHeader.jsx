...
export default function UserHeader() {
    ...
    return (
        <header>
            <nav className="fixed top-0 z-50 w-full flex items-center justify-between transition-transform duration-300 bg-[#ffffff] drop-shadow-[0_4px_12px_rgba(22,34,55,0.06)]">
